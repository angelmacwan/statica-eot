...
export const GEARBOX_CATALOG: GearboxCatalogItem[] = [
  // Hoist Gearboxes
  {
    id: 'gb-hoist-hr500-103',
    model: 'HR 500 + 150',
    type: 'Horizontal Helical Multi-stage',
    ratio: 103.4,
    stages: 3,
    ratedPowerKw: 15.0,
    ratedPowerHp: 20.1,
  ...
  // Cross Travel Gearboxes
  {
    id: 'gb-ct-vr250-21.5',
    model: 'VR 250 / 21.5',
    type: 'Vertical / Helical Shaft Mounted',
    ratio: 21.5,
    stages: 2,
    ratedPowerKw: 1.5,
    ratedPowerHp: 2.01,
    weightKg: 150,
    application: 'CROSS_TRAVEL',
  },
  {
    id: 'gb-ct-vr200-16',
    model: 'VR 200 / 16',
  ...
  {
    id: 'gb-lt-vr350-21.5',
    model: 'VR 350 / 21.5 (Workbook Sample)',
    type: 'Vertical / Helical Shaft Mounted',
    ratio: 21.5,
    stages: 2,
    ratedPowerKw: 2.2,
