...
export const crabWeight: CalculationToolDefinition = {
  ...
  inputs: [
    ...
    {
      key: 'hoistGearboxKg',
      label: 'Hoist Gearbox Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 450.0,
      required: true,
      min: 0,
      description: 'Main hoist reducer weight',
    },
    {
      key: 'hoistMotorKg',
      label: 'Hoist Motor Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 123.0,
      required: true,
      min: 0,
      description: 'Main hoist electric motor',
    },
    {
      key: 'hoistBrakeKg',
      label: 'Hoist Brake Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 27.0,
      required: true,
      min: 0,
      description: 'Thruster drum brake weight',
    },
    {
      key: 'ropeDrumKg',
      label: 'Rope Drum Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 400.0,
      required: true,
      min: 0,
      description: 'Grooved drum shell, shafts, flanges',
    },
    {
      key: 'drumPedestalKg',
      label: 'Drum Pedestal Bearing Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 30.0,
      required: true,
      min: 0,
      description: 'Pedestal block with spherical bearing',
    },
    {
      key: 'bottomBlockKg',
      label: 'Bottom Pulley Block Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 260.0,
      required: true,
      min: 0,
      description: 'Hook, crosshead, sheaves and side plates',
    },
    {
      key: 'upperPulleyKg',
      label: 'Upper Pulley Block Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 0.0,
      required: true,
      min: 0,
      description: 'Fixed top sheave arrangement',
    },
    {
      key: 'equalizingPulleyKg',
      label: 'Equalizing Pulley Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 50.0,
      required: true,
      min: 0,
      description: 'Compensating sheave and bracket',
    },
    {
      key: 'wireRopeTotalKg',
      label: 'Wire Rope Total Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 95.0,
      required: true,
      min: 0,
      description: 'Reeved wire rope dead weight',
    },

    // Cross Travel Components
    {
      key: 'ctGearboxKg',
      label: 'CT Gearbox Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 150.0,
      required: true,
      min: 0,
      description: 'Cross travel reducer',
    },
    {
      key: 'ctMotorKg',
      label: 'CT Motor Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 7.0,
      required: true,
      min: 0,
      description: 'CT motor',
    },
    {
      key: 'ctBrakeKg',
      label: 'CT Brake Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 17.0,
      required: true,
      min: 0,
      description: 'CT thruster brake',
    },
    {
      key: 'ctWheelsKg',
      label: 'CT Wheels Total Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 140.0,
      required: true,
      min: 0,
      description: '4 wheels (35 kg each)',
    },
    {
      key: 'ctCouplingsKg',
      label: 'CT Couplings Total Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 20.0,
      required: true,
      min: 0,
      description: 'Couplings and brake drum',
    },
    {
      key: 'ctFloatingShaftKg',
      label: 'Floating Shaft Weight',
      unit: 'kg',
      type: 'number',
      defaultValue: 30.0,
      required: true,
      min: 0,
      description: 'Line shaft connecting drive',
    },

    // Trolley Structure
    {
      key: 'trolleyStructureKg',
      label: 'Trolley Structural Frame',
      unit: 'kg',
      type: 'number',
      defaultValue: 700.0,
      required: true,
      min: 0,
      description: 'Welded steel plate chassis',
    },
    {
      key: 'allowanceFactor',
      label: 'Design Allowance Factor',
      unit: '',
      type: 'number',
      defaultValue: 1.25,
      required: true,
      min: 1.0,
      description: 'Contingency factor (1.25 in workbook)',
    },
  ],

  outputs: [
    {
      key: 'hoistMachineryTotalKg',
      label: 'Total Hoist Machinery Weight',
      unit: 'kg',
      description: 'Sum of hoisting components',
    },
    {
      key: 'ctMachineryTotalKg',
      label: 'Total Cross Travel Machinery Weight',
      unit: 'kg',
      description: 'Sum of CT drive components',
    },
    {
      key: 'netCrabWeightKg',
      label: 'Net Crab Weight (Unfactored)',
      unit: 'kg',
      description: 'Hoist + CT + Structure (D28)',
    },
    {
      key: 'factoredCrabWeightKg',
      label: 'Factored Crab Weight (with 25% margin)',
      unit: 'kg',
      description: 'Net weight * 1.25 (G28)',
    },
    {
      key: 'factoredCrabWeightTonnes',
      label: 'Factored Crab Weight (Tonnes)',
      unit: 't',
      description: 'Weight in tonnes to use in Master Spec',
    },
  ],
  ...
  calculate(inputs: Record<string, any>): CalculationResult {
    ...
    const ctMachineryTotalKg = ctGearboxKg + ctMotorKg + ctBrakeKg + ctWheelsKg + ctCouplingsKg + ctFloatingShaftKg;
