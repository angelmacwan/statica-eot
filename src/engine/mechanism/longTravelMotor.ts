...
export const longTravelMotor: CalculationToolDefinition = {
  ...
  inputs: [
    ...
    },
    {
      ...
      required: true,
      min: 0.1,
      description: 'Bridge structural dead weight (J10)',
    },
    {
      ...
      required: true,
      min: 1.0,
      description: 'Bridge travel speed (J12)',
    },
    {
      key: 'ltServiceFactor',
      label: 'LT Service Factor (J13)',
      unit: '',
      type: 'number',
      defaultValue: 0.67,
      required: true,
    ...
    },
    {
      ...
      required: true,
      min: 1.0,
      description: 'Long travel rail friction',
    },
    {
      key: 'ltAccelerationResistance',
      label: 'Acceleration Factor (J19)',
      unit: '',
      type: 'number',
      defaultValue: 3.422540622,
      required: true,
      min: 0.1,
      description: 'Bridge inertia factor',
    },
    {
  ...
  outputs: [
    {
      key: 'totalMovingMassTonnes',
      label: 'Total Moving Mass (J11)',
      unit: 't',
      description: 'SWL + Crane Dead Weight',
    },
    { key: 'driveEfficiency', label: 'Gearbox Efficiency (J20)', unit: '', description: '0.95^stages' },
    {
      key: 'requiredMotorKw',
      label: 'Required LT Motor Power',
      unit: 'kW',
      description: 'Calculated motor power in kW (H23)',
    },
    {
      key: 'requiredMotorHp',
      label: 'Required LT Motor Power (HP)',
      unit: 'HP',
  ...
  dependencies: [
    ...
    {
      sourceToolId: 'master',
      sourceKey: 'craneDeadWeightTonnes',
      targetKey: 'craneDeadWeightTonnes',
      label: 'Crane Weight',
    },
    {
      sourceToolId: 'master',
    ...
    {
      sourceToolId: 'master',
      sourceKey: 'ltFrictionFactor',
      targetKey: 'ltFrictionFactor',
      label: 'LT Friction Factor',
    },
  ],
  ...
  calculate(inputs: Record<string, any>): CalculationResult {
    ...
    const ltAccelerationResistance = assertPositiveNumber(
      inputs.ltAccelerationResistance ?? 3.4225406215836034,
      'ltAccelerationResistance',
    );
    ...
    const term1 =
      (totalMovingMassTonnes * longTravelSpeedMPerMin * ltServiceFactor * ltDutyFactor * ltMotorMultiplicity) /
      (6117 * ltTorqueFactor * ambientDeratingFactor);
