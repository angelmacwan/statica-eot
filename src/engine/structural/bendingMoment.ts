...
export const bendingMoment: CalculationToolDefinition = {
  ...
  description: 'Calculates end reactions, maximum bending moment from twin wheel loads and uniform girder self-weight, and bending stress for simply-supported crane girders.',
  sourceWorkbook: 'MAC-Box Beam-Properties.xlsx',
  sourceSheets: ['B.M.'],

  inputs: [
    { key: 'spanM', label: 'Girder Span (L)', unit: 'm', type: 'number', defaultValue: 10.0, required: true, min: 2.0, description: 'Center to center rail span' },
    { key: 'wheelLoad1Tonnes', label: 'Trolley Wheel Load 1 (P1)', unit: 't', type: 'number', defaultValue: 3.75, required: true, min: 0.1, description: 'Maximum wheel load 1' },
    { key: 'wheelLoad2Tonnes', label: 'Trolley Wheel Load 2 (P2)', unit: 't', type: 'number', defaultValue: 3.75, required: true, min: 0.1, description: 'Maximum wheel load 2' },
    { key: 'wheelBaseM', label: 'Trolley Wheelbase (b)', unit: 'm', type: 'number', defaultValue: 1.5, required: true, min: 0.5, description: 'Distance between trolley wheels' },
    { key: 'selfWeightKgPerM', label: 'Girder Self Weight', unit: 'kg/m', type: 'number', defaultValue: 250.0, required: true, min: 10.0, description: 'Uniform self weight of girder' },
    { key: 'impactFactor', label: 'Dynamic Impact Factor', unit: '', type: 'number', defaultValue: 1.25, required: true, min: 1.0, description: 'Vertical dynamic multiplier' },
    { key: 'sectionModulusZxxCm3', label: 'Section Modulus Zxx', unit: 'cm3', type: 'number', defaultValue: 8500.0, required: true, min: 100.0, description: 'Major axis elastic section modulus' },
  ],

  outputs: [
    { key: 'maxLiveBendingMomentKnm', label: 'Maximum Wheel Load Moment', unit: 'kN.m', description: 'Peak moment from trolley wheels' },
    { key: 'maxDeadBendingMomentKnm', label: 'Girder Dead Load Moment', unit: 'kN.m', description: 'w * L^2 / 8' },
    { key: 'totalDesignBendingMomentKnm', label: 'Total Design Bending Moment', unit: 'kN.m', description: 'Impact-adjusted total moment' },
    { key: 'calculatedBendingStressMpa', label: 'Calculated Bending Stress', unit: 'N/mm2', description: 'M / Zxx' },
    { key: 'leftReactionKn', label: 'Maximum End Reaction (Left)', unit: 'kN', description: 'Reaction at left support' },
    { key: 'rightReactionKn', label: 'Maximum End Reaction (Right)', unit: 'kN', description: 'Reaction at right support' },
  ],

  dependencies: [
    { sourceToolId: 'cross-travel-wheel', sourceKey: 'pMaxTonnes', targetKey: 'wheelLoad1Tonnes', label: 'Wheel Load 1' },
    { sourceToolId: 'cross-travel-wheel', sourceKey: 'pMaxTonnes', targetKey: 'wheelLoad2Tonnes', label: 'Wheel Load 2' },
