...
export const gantryLeg: CalculationToolDefinition = {
  ...
  inputs: [
    {
      key: 'legHeightM',
      label: 'Clear Leg Height (H)',
      unit: 'm',
      type: 'number',
      defaultValue: 8.0,
      required: true,
      min: 2.0,
      description: 'Ground to girder rail elevation',
    },
    {
      key: 'legWheelBaseM',
      label: 'Leg Wheelbase at Ground (B)',
      unit: 'm',
      type: 'number',
      defaultValue: 4.5,
      required: true,
      min: 1.5,
      description: 'Distance between end carriage wheels',
    },
    {
      key: 'verticalLoadTonnes',
      label: 'Maximum Vertical Leg Reaction',
      unit: 't',
      type: 'number',
      defaultValue: 32.5,
      required: true,
      min: 5.0,
      description: 'Vertical dead + live load on leg',
    },
    {
      key: 'windPressureServiceNPerM2',
      label: 'Operating Wind Pressure',
      unit: 'N/m2',
      type: 'number',
      defaultValue: 250.0,
      required: true,
      min: 100.0,
      description: 'Service state wind pressure',
    },
    {
      key: 'windPressureStormNPerM2',
      label: 'Storm Wind Pressure',
      unit: 'N/m2',
      type: 'number',
      defaultValue: 1000.0,
      required: true,
      min: 500.0,
      description: 'Non-operating storm wind pressure',
    },
  ],

  outputs: [
    {
      key: 'stabilisingMomentKnm',
      label: 'Stabilising Moment (M_stab)',
      unit: 'kN.m',
      description: 'Restoring gravity moment',
    },
    {
      key: 'serviceOverturningMomentKnm',
      label: 'Service Overturning Moment',
      unit: 'kN.m',
      description: 'Operating wind and inertia moment',
    },
    { key: 'serviceStabilityFactor', label: 'Service Stability Factor', unit: '', description: 'M_stab / M_overturn' },
    {
      key: 'stormStabilityFactor',
      label: 'Storm Stability Factor',
      unit: '',
      description: 'Storm condition factor of safety',
    },
  ],
  ...
  calculate(inputs: Record<string, any>): CalculationResult {
    ...
    return {
      ...
      outputs: {
        ...
        serviceOverturningMomentKnm: {
          value: serviceOverturningMomentKnm,
          unit: 'kN.m',
          label: 'Service Overturning Moment',
        },
